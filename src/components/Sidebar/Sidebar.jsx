...
import tech from '../../assets//music.png'
  ...
  return (
    ...
    <div className="shortcut-links">
        ...
        <div className={`side-links ${category===2?"active":""}`} onClick={()=>setCategory(2)}>
            <img src={automobiles} alt=""/><p>Automob</p>
        </div>
    ...
    <div className="subscribed-list">
        ...
        <div className="side-links">
            <img src={jack} alt="" /><p>Carlo</p>
        </div>
        <div className="side-links">
            <img src={simon} alt="" /><p>MrBeast</p>
        </div>
        <div className="side-links">
            <img src={tom} alt="" /><p>TayloRSwift</p>
        </div>
        <div className="side-links">
            <img src={megan} alt="" /><p>5 Crafts</p>
        </div>
        <div className="side-links">
            <img src={cameron} alt="" /><p>Daisy</p>
        </div>
    </div>
